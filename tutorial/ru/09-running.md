...
**Это не фоновый режим** — бот остановится, когда вы закроете терминал. Для постоянной работы используйте PM2 (ниже) или Docker ([глава 10](10-docker.md)).
